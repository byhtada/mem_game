...
help:
	...
	@echo "  watch-frontend - Автоматически пересобирать при изменениях JS/CSS"
...
# Автоматическое отслеживание изменений JS/CSS
watch-frontend:
	@echo "🔄 Запуск автоматического отслеживания фронтенда..."
	@chmod +x scripts/watch-frontend.sh
